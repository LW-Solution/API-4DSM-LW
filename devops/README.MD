...
Essas libs foram escolhidas pois o Jest é um framework que cria um ambiente de testes virtual para rodar os scripts descritos pelos teste e providencia métodos para organizar os testes a serem criados.
